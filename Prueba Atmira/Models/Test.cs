...
namespace Prueba_Atmira.Models
{
    ...
    public partial class Asteroids
    {
        public static Asteroids FromJson(string json) => JsonConvert.DeserializeObject<Asteroids>(json, Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Asteroids self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
    }
